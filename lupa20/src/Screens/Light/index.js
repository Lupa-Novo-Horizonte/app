    ...
    const saveData = async () =>{
        ...
        else
        {
            ...
            else
            {
                ...
                if(ddl04 == 0)
                    var res = await Api.postLight(markerRegion.coords.latitude.toString(), markerRegion.coords.longitude.toString(),null, ddl01, ddl02, ddl03, token);
                else
                    var res = await Api.postLight(null, null, JSON.stringify(capturePoint.routeCoordinates), ddl01, ddl02, ddl03, token);
    ...
    return (
        <SafeAreaView style={sharedStyles.container}>
            ...
            <ScrollView style={sharedStyles.scroller}>             
                    ...
                    >
                        {   
                            ...
                            <Marker coordinate={markerRegion.coords}>
                                <Image source={sharedVariables.lightIconColor} style={{height: 80, width: 49}}></Image>
                            </Marker>
                        }
                        {
                            (ddl04 == 1) &&
                ...
                <Text style={sharedStyles.headerSubTitle}>Iluminação Pública</Text>
                ...
                <View>
                    <View style={sharedStyles.area}>
                        <View style={sharedStyles.subArea01}>
                            <View style={sharedStyles.subSubArea01}>
                                <Text style={sharedStyles.titleText}>Possui poste?</Text>
                            </View>
                        ...
                        <SelectDropdown
                            ...
                            onSelect={(selectedItem, index) => { 
                                ...
                                setDdl02((selectedItem=='Não'? false : null))
                            }}
                    ...
                    {ddl01 == true ? 
                        <View style={sharedStyles.area}>
                            <View style={sharedStyles.subArea01}>
                                <View style={sharedStyles.subSubArea01}>
                                    <Text style={sharedStyles.titleText}>As luzes estão funcionando?</Text>
                                </View>
                                <View style={sharedStyles.subSubArea02}>
                                    <HorizontalBar />
                                </View>
                        ...
                        <View style={sharedStyles.area}>
                            <View style={sharedStyles.subArea01}>
                                <View style={sharedStyles.subSubArea01}>
                                    <Text style={sharedStyles.titleTextDisabled}>Se sim, as luzes estão funcionando?</Text>
                                </View>
                                <View style={sharedStyles.subSubArea02}>
                                    <HorizontalBar />
                                </View>
                            ...
                            <View style={sharedStyles.subArea02}>
                                <SelectDropdown
                                    defaultButtonText={ddl01 == false ? 'Não' : 'Selecione'}
                                    disabled={true}
                                    key={'ddl02Key'}
                    ...
                    <View style={sharedStyles.area}>
                        <View style={sharedStyles.subArea01}>   
                            <View style={sharedStyles.subSubArea01}>
                                <Text style={sharedStyles.titleText}>Há fios elétricos soltos?</Text>
                            </View>
                            <View style={sharedStyles.subSubArea02}>
                                <HorizontalBar />
                            </View>
