    ...
    const saveData = async () =>{
        ...
        else
        {
            ...
            else
            {
                ...
                let res = await Api.postTrash(markerRegion.coords.latitude.toString(), markerRegion.coords.longitude.toString(), ddl01, ddl02, ddl03, token);
        ...
        <SafeAreaView style={sharedStyles.container}>
            ...
            <ScrollView style={sharedStyles.scroller}>             
                ...
                <View style={sharedStyles.area}>
                    <View style={sharedStyles.subArea01}>
                        <View style={sharedStyles.subSubArea01}>
                            <Text style={sharedStyles.titleText}>Existe limpeza da prefeitura na sua rua?</Text>
                        </View>
                ...
                <View style={sharedStyles.area}>
                    <View style={sharedStyles.subArea01}>   
                        <View style={sharedStyles.subSubArea01}>
                            <Text style={sharedStyles.titleText}>Existe lixo acumulado na rua?</Text>
                        </View>
                        <View style={sharedStyles.subSubArea02}>
                            <HorizontalBar />
                        </View>
